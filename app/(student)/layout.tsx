...
import { LayoutDashboard, User, ClipboardList, LogOut, Bell } from "lucide-react"
...
const navItems = [
  ...
  { href: "/student/questionnaire", label: "Questionnaire", icon: ClipboardList },
]
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                <DropdownMenuLabel className="text-xs text-slate-500">CSC/19/0012</DropdownMenuLabel>
                <DropdownMenuSeparator />
